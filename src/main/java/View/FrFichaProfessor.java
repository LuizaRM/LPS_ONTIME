 ...
 * @author luikt
 */
public class FrFichaProfessor extends javax.swing.JFrame {

    /**
     * Creates new form JrFichaUsuario
     */
    public FrFichaProfessor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jblTitulo1.setText("Ficha do Professor");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        FrEditarProfessor telaCadastro = new FrEditarProfessor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrFichaProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrFichaProfessor().setVisible(true);
            }
        });
    }
